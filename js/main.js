...
// ! Обработчик в then, catch, finally для создания цепочки может возвращать не промис, а любой другой объект, содержащий метод then (thenable object). Это может быть полезно при использовании сторонних реализаций thenable объекта, совместимых со стандартными промисами
